...
import "./Home.css";
import { destaquesVar } from "../../graphql/destaques/state";
...
const Home = () => {
  ...
  useDestaques();
  const destaques = useReactiveVar(destaquesVar);

  const { lancamentos, maisVendidos } = destaques;
  // console.log(lancamentos, maisVendidos);
